...
<!--[if gt IE 99]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <![endif]-->
		 ...
		 <div class="header">
		  <table  style='width:98%;height:75%;'><tr><td style="width:80%;" rowspan="3"><img src="img/header.png"></td><td colspan="2" height="90%"><div class="atasmenu" style="margin-bottom:33%;border:0px solid black;width:100%;"><font style="text-transform:uppercase;"><SCRIPT language="JavaScript">var d = new Date();
            var h = d.getHours();
